...
if(output.find("already exist")):
        ...
        cmd="java -jar trusted-app-client-0.0.1-jar-with-dependencies.jar -action i -username "+user+"  -id camicSignup -secret 9002eaf56-90a5-4257-8665-6341a5f77107 -comments loader -lifetime 999999999  -url http://quip-data:9099/trustedApplication > userinfo2"
        os.system(cmd)
